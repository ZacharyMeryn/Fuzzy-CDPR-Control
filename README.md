# ImpactfulFuzzballs
Everything we need for the springer article and maybe go on to use for IMPACT
This is gonna serve as the hub for all the code we're using this semester and maybe beyond. For now, theres just one file, that may or may not change eventually.
